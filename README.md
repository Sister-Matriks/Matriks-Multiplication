...
Cara menggunakan matriks.sh
	* Program matriks.sh akan dapat memiliki argumen integer maksimal 2 buah
	* Jika tidak ada argumen, maka program akan membuat matriks berukuran 4 x 4 dengan value random 
...
Contoh
$./matriks.sh
Menghasilkan matriks berukuran 4 x 4 dengan value random
